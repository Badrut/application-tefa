                    ...
                    <div class="box">
                        <div class="p-5">
                            ...
                            <div class="text-slate-600 dark:text-slate-500 mt-5">
                                <div class="flex items-center"> <i data-lucide="link" class="w-4 h-4 mr-2"></i> Total
                                    Anggaran: {{ number_format($project->total_amount, 0, ',', '.') }}</div>
                                <div class="flex items-center mt-2"> <i data-lucide="layers" class="w-4 h-4 mr-2"></i>
                                    Estimasi Waktu: {{ $project->valid_until->diffForHumans() ?? 'Belum ditentukan' }}</div>
                            </div>
                        </div>
                        <div
                            class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            <a class="flex items-center text-primary mr-auto"
                                href="{{ route('proyek.show', $project->id) }}"> <i data-lucide="eye"
                                    class="w-4 h-4 mr-1"></i> Detail </a>
                            @role('teacher')
                                <a class="flex items-center mr-3" href="{{ route('proyek.edit', $project->id) }}"> <i
