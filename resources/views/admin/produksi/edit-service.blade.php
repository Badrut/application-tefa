...
@section('content')
                                <div class="intro-y box col-span-12 lg:col-span-12 mt-5">
                                    ...
                                    <div class="border box border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                            <form id="service-form" method="POST" action="{{ route('admin.produksi.update-service', $service->id) }}" class="mt-5" enctype="multipart/form-data">
                                            @csrf
                                                @method('PUT')
                                            {{-- Nama --}}
                                            <div class="form-inline items-start flex-col xl:flex-row">
                                                <div class="form-label xl:w-64 xl:!mr-10">
                                                    <div class="text-left">
                                                        <div class="font-medium">Nama Service</div>
                                                ...
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    @error('name')
                                                        <div class="mt-3">
                                                            <input id="input-name" type="text" name="name" class="form-control border-danger" placeholder="Input text" value="{{ old('name', $service->name ?? '') }}">
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                ...
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    @error('code')
                                                        <div class="mt-3">
                                                            <input id="input-code" type="text" name="code" class="form-control border-danger" placeholder="Input text" value="{{ old('code', $service->code ?? '') }}">
                                                            <div class="text-danger mt-2">{{ $message }}</div>
                                                        </div>
                                                    @else
                                                        <input
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                ...
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    @error('description')
                                                        <div class="mt-3">
                                                            <input id="input-description" type="text" name="description" class="form-control border-danger" placeholder="Input description" value="{{ old('description', $service->description ?? '') }}">
                                                            <div class="text-danger mt-2">{{ $message }}</div>
                                                        </div>
                                                    @else
                                                        <input
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                ...
                                                <div class="text-left">
                                                    <div class="flex items-center">
                                                        <div class="font-medium">Harga Service</div>
                                                    </div>
                                                     <div class="leading-relaxed text-slate-500 text-xs mt-3"> Harga service per paket atau per satuan sesuai kebutuhan.</div>
                                                </div>
                                            </div>
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    @error('base_price')
                                                        <div class="mt-3">
                                                            <input id="input-base_price" type="text" name="base_price" class="form-control border-danger" placeholder="Input text" value="{{ old('base_price', $service->base_price ?? '') }}">
                                                            <div class="text-danger mt-2">{{ $message }}</div>
                                                        </div>
                                                    @else
                                                        <input
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                ...
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    @error('unit')
                                                        <div class="mt-3">
                                                            <input id="input-phone" type="text" name="unit" class="form-control border-danger" placeholder="Input text" value="{{ old('unit', $service->unit ?? '') }}">
                                                            <div class="text-danger mt-2">{{ $message }}</div>
                                                        </div>
                                                    @else
                                                        <input
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                <div class="form-label xl:w-64 xl:!mr-10">
                                                    <div class="text-left">
                                                        <div class="font-medium">Level Service</div>
                                                        <div class="leading-relaxed text-slate-500 text-xs mt-3">Contoh: Basic / Standard / Premium</div>
                                                    </div>
                                                </div>
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    <input type="text" name="service_level" class="form-control" value="{{ old('service_level', $service->service_level ?? '') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                ...
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                    <input type="number" name="estimated_hours" class="form-control" value="{{ old('estimated_hours', $service->estimated_hours ?? '') }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5">
                                                <div class="form-label xl:w-64 xl:!mr-10">
                                                    <div class="text-left">
                                                        <div class="font-medium">Service Jurusan</div>
                                                        <div class="leading-relaxed text-slate-500 text-xs mt-3">
                                                                Service ini dibuat oleh jurusan apa
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                                     <div class="">
                                                            ...
                                                            class="tom-select w-full">
                                                                    @foreach ($majors as $major)
                                                                                <option value="{{ $major->id }}" {{ (old('major_id', $service->major_id ?? '') == $major->id) ? 'selected' : '' }}>{{ $major->name }}</option>
                                                                            @endforeach
                                                            </select>
                                                        </div>
                                                </div>
                                            ...
                                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                                    <div class="form-label xl:w-64 xl:!mr-10">
                                                        <div class="text-left">
                                                            <div class="flex items-center">
                                                                <div class="font-medium">Status Service</div>
                                                            </div>
                                                            <div class="leading-relaxed text-slate-500 text-xs mt-3"> Status service </div>
                                                        </div>
                                                    </div>
                                                    <div class="w-full mt-3 xl:mt-0 flex-1">
                                                        <div class="form-check form-switch">
                                                            ...
                                                            >
                                                            <label class="form-check-label" for="service-status-active">Aktif</label>
                                                        </div>
                                                    </div>
                                                </div>
