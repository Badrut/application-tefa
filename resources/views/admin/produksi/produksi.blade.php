                    ...
                    <h2 class="intro-y text-lg font-medium mt-10">
                        ...
                        <div class="tab-content">
                            <div id="layout-1-monthly-fees" class="tab-pane active" role="tabpanel" aria-labelledby="layout-1-monthly-fees-tab">
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                                        <a href="{{ route('admin.produksi.add-product') }}" class="btn btn-primary shadow-md mr-2">Tambah Produk Baru</a>
                                        <div class="dropdown">
                                        ...
                                        <form method="GET" action="{{ route('admin.produksi') }}" class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                            ...
                            <div id="layout-1-annual-fees" class="tab-pane" role="tabpanel" aria-labelledby="layout-1-annual-fees-tab">
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                                        <a href="{{ route('admin.produksi.add-service') }}" class="btn btn-primary shadow-md mr-2">Tambah Jasa Baru</a>
                                        <div class="dropdown">
                                            <button class="dropdown-toggle btn px-2 box" aria-expanded="false" data-tw-toggle="dropdown">
                                                <span class="w-5 h-5 flex items-center justify-center"> <i class="w-4 h-4" data-lucide="plus"></i> </span>
                                            </button>
                                    ...
                                    @foreach ($services as $service)
                                        <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                                            <div class="box">
                                                ...
                                                <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                                                    <a class="flex items-center text-primary mr-auto" href="{{ route('admin.produksi.detail-service' , $service->id) }}"> <i data-lucide="eye" class="w-4 h-4 mr-1"></i> Preview </a>
                                                    <a class="flex items-center mr-3" href="{{ route('admin.produksi.edit-service' , $service->id) }}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
