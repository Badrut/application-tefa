...
@section('content')
                                ...
                                <div class="intro-y box col-span-12 lg:col-span-12 mt-5">
                                    ...
                                    <div class="border box border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                        <form method="POST" action="{{ route('admin.master-data.major-update' , $major->id) }}" class="mt-5">
                                            @csrf
                                            @method('PUT')
                                                     ...
                                                     <div class="">
                                                            ...
                                                            class="tom-select w-full">
                                                                    @foreach ($users as $user)
                                                                        @if ($user->teacher)
                                                                            <option value="{{ $user->teacher->id }}"
                                                                                {{ old('head_teacher_id', $major->head_teacher_id) == $user->teacher->id ? 'selected' : '' }}>
                                                                                {{ $user->name }}
                                                                            </option>
                                                                        @endif
                                                                    @endforeach
